...
public class SolicitudesPagosController {
    ...
    public ResponseEntity<List<LicenciaFiniquitoDTO>> obtenerLicenciaFiniquito(@Param("rutBeneficiario") Integer rutBeneficiario,
        ...
        try {
            log.info("CONTROLLER nroLicencia: {}", nroLicencia);
            log.info("CONTROLLER rutBeneficiario: {}", rutBeneficiario);
            log.info("CONTROLLER fechaInicio: {}", fechaInicio);
            log.info("CONTROLLER fechaFin: {}", fechaFin);
