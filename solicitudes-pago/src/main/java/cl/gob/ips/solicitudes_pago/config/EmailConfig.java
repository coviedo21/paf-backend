...
public class EmailConfig {
    ...
    public JavaMailSender javaMailSender() {
        ...
        props.put("mail.smtp.connectiontimeout", "5000"); // Timeout para conexiones (5 segundos)
        props.put("mail.smtp.timeout", "5000"); // Timeout general (5 segundos)
        props.put("mail.smtp.writetimeout", "5000"); // Timeout para escritura (5 segundos)
