...
public interface EmisionService {
    Boolean validarSolicitudesEmitidas(List<EmisionArchivoDTO> emision, int idProceso, String token);
    ...
    boolean insertarPagoRetencion(PagoRetencionDTO dto, String token);
}