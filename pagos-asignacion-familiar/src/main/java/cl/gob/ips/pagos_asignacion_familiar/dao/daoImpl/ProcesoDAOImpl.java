...
public class ProcesoDAOImpl implements ProcesoDAO {
    ...
    public int insertarProceso(ProcesoDTO insertarProcesoDTO) {
        SimpleJdbcCall jdbcCall = new SimpleJdbcCall(jdbcTemplate).withSchemaName(esquema)
                ...
                .declareParameters(
                        new SqlParameter("vcMesProceso", Types.VARCHAR),
                        new SqlParameter("iAnoProceso", Types.INTEGER),
                        ...
                        new SqlParameter("dFechaPago", Types.DATE),
                        new SqlOutParameter("idProceso", Types.INTEGER));

        MapSqlParameterSource inParams = new MapSqlParameterSource()
                .addValue("vcMesProceso", insertarProcesoDTO.getMesProceso())
                .addValue("iAnoProceso", insertarProcesoDTO.getAnoProceso())
...
public List<ProcesoDTO> consultarProceso(Long idProceso) {
    ...
    for (Map<String, Object> u : results) {
        ...
        if (u.get("MesProceso") != null) procesoDTO.setMesProceso((String) u.get("MesProceso"));
        if (u.get("AnoProceso") != null) procesoDTO.setAnoProceso((Integer) u.get("AnoProceso"));
        ...
        if (u.get("Periodo") != null) procesoDTO.setPeriodo((Integer) u.get("Periodo"));
        ...
        if (u.get("fechaPago") != null) procesoDTO.setFechaPago((Date) u.get("fechaPago"));
...
public List<ProcesoDTO> filtrarProcesos(String texto) {
    ...
    try {
        ...
        for (Map<String, Object> row : results) {
            ...
            if (row.get("mesProceso") != null) procesoDTO.setMesProceso((String) row.get("mesProceso"));
            if (row.get("anoProceso") != null) procesoDTO.setAnoProceso((Integer) row.get("anoProceso"));
            ...
            if (row.get("periodo") != null) procesoDTO.setPeriodo((Integer) row.get("periodo"));
            ...
            if (row.get("fechaPago") != null) procesoDTO.setFechaPago((Date) row.get("fechaPago"));
            procesos.add(procesoDTO);
        }
    } catch (Exception e) {
